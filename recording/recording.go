...
var recordingBaseUrl = helpers.GetEndpointUrl("recordings")
...
func StopRecording(ctx *gin.Context) {
	...
	if !ok {
		ctx.AbortWithStatusJSON(http.StatusUnprocessableEntity, gin.H{"error": hms_errors.ErrMissingRecordingId})
	}
